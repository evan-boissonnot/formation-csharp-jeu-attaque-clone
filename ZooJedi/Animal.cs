...
namespace ZooJedi
{
    public class Animal
    {
        public static int NbPattesParDefaut = 4;
        public static void Afficher(Animal aa)
        {
            Console.WriteLine("ssssss");
        }

        public Animal(DateTime dateDeNaissance, string nom)
        {
            this.NombreDePattes = Animal.NbPattesParDefaut;
